package com.omt.learn.geekforgeek.linkedlist;
...
public class FlatLinkedList {
    ...
    public void algoFlatList(Node head) {
        Queue<Node> queue = new LinkedList();

        Node currentNode = head;
        queue.add(head);
        while (currentNode.next != null || !queue.isEmpty()) {
    ...
    public void flagList(Queue<Node> q, Node h) {
